...
/**
 * Génère la vue pour afficher les annonces de véhicules.
 * @param {Array} annonces - Tableau des annonces de véhicules à afficher.
 ...
 * @returns {string} HTML généré pour la page des annonces de véhicules.
 */
function vehiculeView(annonces, flash = {}, role) {
    // Début de la construction du HTML pour la vue des annonces de véhicules
    ...
    annonces.forEach(annonce => {
        ...
        console.log("images immo : ", images); // Affichage des images dans la console pour débogage
...
// Exportation de la fonction vehiculeView pour l'utiliser ailleurs dans l'application
