...
/**
 * Génère la vue pour la page des annonces de maisons et jardins.
 ...
 * @returns {string} HTML généré pour la page des annonces de maisons et jardins.
 */
function maisonView(annonces, flash = {}, role) {
        ...
        <div class="bg-zinc-200 min-h-screen py-8">
            ...
            <div class="container mx-auto">
                ...
                <div class="flex flex-col items-center mb-4">
                    <h1 class="text-3xl font-bold text-center mb-8">Annonces Maison et Jardin</h1>
...
// Exportation de la fonction maisonView pour l'utiliser ailleurs dans l'application
module.exports = maisonView;
